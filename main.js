...
const dbURI = `mongodb+srv://testUser:${process.env.DB_PASSWORD}@testcluster1.lmbcb.mongodb.net/CW?retryWrites=true&w=majority`;
...
app.use("/admin/resources", checkAuthenticated, require("./routes/admin/resource"));
app.use("/admin/archives", checkAuthenticated, require("./routes/admin/archive"));
